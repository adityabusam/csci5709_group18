...
export default function Checkout(props) {
    ...
    const handleZipChange = (e) => {
        if(!zipRegex.test(e.target.value) && e.target.value){
            setZipErrorMessage("Field should start with 1-4 numbers and should be minimum 8 character long");
        }else{
            setZipErrorMessage("");
        }
    ...
    return (
        <Layout>
            ...
            <Grid 
                ...
                style={{ minHeight: '30vh' }}><h1 className="textFont">Checkout Summary</h1></Grid>  {/* Important snipet to align content inside grid */} 
